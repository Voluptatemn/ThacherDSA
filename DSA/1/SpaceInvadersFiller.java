...
public class SpaceInvadersFiller {
	...
	public void move() {
		...
		for (int i = 0; i < aliens.size(); i++) {
			...
			if(Math.random() >= DIFFICULTY) {
				Laser Laser = new Laser(aliens.get(i).x, aliens.get(i).y, LASERWIDTH, LASERHEIGHT, "1/218-2186445_bullet-clipart.png-2-removebg-preview.png");
		...
		if (shields.size() < 3) {
				...
				Shield shield = new Shield(x, HEIGHT/7*6, PLAYERWIDTH, PLAYERHEIGHT, "1/shield-icon-protection-symbol-security-emblem-in-line-style-2H9PN54-removebg-preview.png");
				shields.add(shield);
		}
	...
	public void setup() {
		 ...
		 player = new SpaceThing(WIDTH/2, HEIGHT/7*6, PLAYERWIDTH, PLAYERHEIGHT, "1/working-removebg-preview.png");
		 
		 for (int i = 0; i < NUMALIENS; i++) {
			 if (NUMALIENS == 1) { // only works it there is one alien
				 SpaceThing alien = new SpaceThing(WIDTH/2, HEIGHT/7, PLAYERENEMYWIDTH, PLAYERENEMYHEIGHT, "1/130-1308618_transparent-alien-spaceship-png-space-ship-2d-png-removebg-preview.png");
				 aliens.add(alien);
			 } else {
			 if (i >= (NUMALIENS / 2)) { // second row
				 SpaceThing alien = new SpaceThing(WIDTH / (NUMALIENS/2) * (i - (NUMALIENS/2)) , HEIGHT/7 * 3 / 2, PLAYERENEMYWIDTH, PLAYERENEMYHEIGHT,  "1/130-1308618_transparent-alien-spaceship-png-space-ship-2d-png-removebg-preview.png");
				 aliens.add(alien); 
			 } else { //first
				 SpaceThing alien = new SpaceThing(WIDTH / (NUMALIENS/2) * i , HEIGHT/7, PLAYERENEMYWIDTH, PLAYERENEMYHEIGHT,  "1/130-1308618_transparent-alien-spaceship-png-space-ship-2d-png-removebg-preview.png");
				 aliens.add(alien); 
			 }
			 }
	...
	public void fireLaser() {
		if (playerLasers.size() < 4) { //check if there is 4 lasers
			Laser Laser = new Laser(player.x, player.y, LASERWIDTH, LASERHEIGHT, "1/BulletUpwards.png");
			playerLasers.add(Laser); 
		} else {
			playerLasers.remove(0);
			Laser Laser = new Laser(player.x, player.y, LASERWIDTH, LASERHEIGHT, "1s/BulletUpwards.png");
			playerLasers.add(Laser); 
		}
	}
